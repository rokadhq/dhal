...
export const DHAL_V1_PUBLIC_EXPORTS: readonly DhalV1PublicExport[] = Object.freeze([
  { path: ".", stability: "stable", purpose: "Core engine, framework adapters, configuration, policies, stores, telemetry, diagnostics, and public types." },
  ...
  { path: "./nest", stability: "stable", purpose: "NestJS bootstrap adapter for Express and Fastify platforms." },
  { path: "./koa", stability: "stable", purpose: "Koa middleware adapter." },
  { path: "./hono", stability: "stable", purpose: "Hono middleware adapter for the Node.js runtime." },
